...
<table width="100%" border="0" align="center" cellpadding="15" cellspacing="0" class="bk_e4e4e4">
    <tr>
        ...
        <td  height="200" align="left" valign="top" bgcolor="#FFFFFF">
            <input type="button" onclick="one()" value="新增用户" style="border: 0px;border-radius: 5px;font-size:17px;border-color: #ccffaa"><br/><br>
            ...
            <tr style="height: 30px;background-color: #55dd88">
                ...
                <td><a href="changeuser.jsp?id=${u.id}">修改</a>&nbsp;<a href="deleteuser.do?id=${u.id}">删除</a></td>
            </tr>
            </c:forEach>
