...
<table width="60%" border="0" align="center" cellpadding="15" cellspacing="0" class="bk_e4e4e4">
    <tr>
            ...
            <table width="100%" border="1" cellspacing="0" cellpadding="0"  style="text-align: center;border-color: white">
                ...
                <c:forEach items="${newsList}" var="n">
                    <tr style="height: 30px;background-color: #55dd88">
                        <td>${n.id}</td>
                        <td>${n.title}</td>
                        <td><a href="changenews.jsp?id=${n.id}&title=${n.title}&content=${n.content}">修改</a>&nbsp;<a href="deletenews.do?id=${n.id}">删除</a></td>
                    </tr>
                </c:forEach>
