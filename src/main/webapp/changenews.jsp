...
<table width="50%" border="0" align="center" cellpadding="15" cellspacing="0" class="bk_e4e4e4">
    <tr>
        ...
        <td  height="200" align="left" valign="top" bgcolor="#FFFFFF">
            <form action="changenews.do" method="post">
                <table width="100%" border="1" cellspacing="0" cellpadding="0"  style="text-align: center;border-color: white">
                    ...
                    <tr style="height: 55px;background-color: #55dd88">
                        <td width="35%"><input type="text" name="title" placeholder="${param.title}">
                            <input type="hidden" value="${param.id}" name="id" style="width: 240px">
                        </td>
                        <td width="65%">
                            <textarea name="content" style="height: 50px; width:300px;">
                                ${param.content.trim()}
                            </textarea>
                        </td>
                    </tr>
